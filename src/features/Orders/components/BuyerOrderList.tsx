...
export const BuyerOrderList: React.FC<BuyerOrderListProps> = () => {
    const { ordersQuery, cancelOrderMutation, completeOrderMutation } = useBuyerOrders();
    ...
    const filteredOrdersMemo = useMemo(() => {
        return orders.filter(order => {
            const matchesSearch = !searchTerm.trim() || order.distributorName.toLowerCase().includes(searchTerm.toLowerCase().trim());
                            ...
                            <div className="flex items-center space-x-4 flex-grow">
                                ...
                                <div className="flex items-center space-x-4 flex-grow text-left">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Distributor: {order.distributorName}</p>
