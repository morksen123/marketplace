...
import { foodCategoryMapping, foodConditionMapping, deliveryMethodMapping, unitMapping, Product, Batch } from '../constants';
                ...
                <div className="flex-grow">
                    <div className="flex justify-between items-start mb-2">
                        <div>
                            ...
                            <p className="text-2xl text-[#017A37] font-semibold text-left">${product.price.toFixed(2)} per {unitMapping[product.foodCategory] || "unit"}</p>
                        </div>
                    ...
                    <div className="mt-4">
                        <div className="flex items-center mb-2">
                            ...
                            <p className="mr-2 font-semibold">{distributor ? distributor.distributorName : 'Distributor not found'}</p>
                            <div className="flex items-center bg-yellow-100 rounded-full px-2 py-1">
                                <StarIcon style={{ color: 'gold', fontSize: '18px' }} />
                                <span className="ml-1 text-sm font-medium">4.5</span>
                            </div>
                            <button className="ml-4 flex items-center bg-[#017A37] hover:bg-[#015A27] text-white rounded-full px-3 py-1 transition duration-300 ease-in-out"
